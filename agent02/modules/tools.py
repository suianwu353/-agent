...
class WeatherClient:
    ...
    def get_mock_weather_data(self, date_str):
        """
        生成模拟天气数据用于测试
        ...
        return {
            'fxDate': date_str,
            'textDay': weather_type,
            'textNight': weather_type,
            'tempMax': random.randint(15, 30),
            'tempMin': random.randint(5, 20),
            'windSpeedDay': random.randint(5, 20),
            'windDirDay': '东南风',
            'humidity': random.randint(40, 90),
            'precip': random.randint(0, 50),
